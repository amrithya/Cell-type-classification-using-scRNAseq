...
parser.add_argument('--task_name', type=str, default='cell-anno', help='task name')
parser.add_argument('--input_type', type=str, default='bulk',choices=['singlecell','bulk'], help='input type; default: singlecell')
...
parser.add_argument('--model_path',  type=str, default='/data1/data/corpus/scMODEL/scfoundation/models.ckpt', help='pre-trained model path')
parser.add_argument('--ckpt_name',  type=str, default='cell-anno', help='checkpoint name')
...
def main():
    ...
    geneexpemb=[]
    batchcontainer = []
    strname = "/data1/data/corpus/scDATA/scfoundation/mt_kidney_rcc_cca_paa_2_scf.npy"
