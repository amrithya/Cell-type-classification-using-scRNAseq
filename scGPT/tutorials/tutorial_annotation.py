...
Original file is located at
    https://colab.research.google.com/drive/1y4lwc3ow981mrFfBKC_DgVf8xoVEqZeJ
...
hyperparameter_defaults = dict(
    seed=0,
    dataset_name="/data1/data/corpus/scDATA/Zheng68K.h5ad",
    do_train=True,
    load_model="/data1/data/corpus/scMODEL/scGPT_human",
    mask_ratio=0.0,
    epochs=10,
    n_bins=51,
